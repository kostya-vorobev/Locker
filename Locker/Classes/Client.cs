...
namespace CleanPCClub
{
    class Client : Human
    {
        ...
        {
            MySqlLib.MySqlData.MySqlExecuteData.MyResultData result = new MySqlLib.MySqlData.MySqlExecuteData.MyResultData();
            string select = "select * from Clients where Login='" + login + "'";
        ...
        public static bool SearchLoginPass(string login, string pass)
        {
            MySqlLib.MySqlData.MySqlExecuteData.MyResultData result = new MySqlLib.MySqlData.MySqlExecuteData.MyResultData();
            string select = "select * from Clients where Login='" + login + "' and Password = '" + pass + "'";
